...
![SocksCap64.png](../Images/DS01.png)
...
![SocksCap64.png](../Images/DS02.png)
...
-  建堆
   ...
   -  如果直接使用未排序的数组初始化数据域，再进行调整的话，时间复杂度可降到 $O(n)$
      ...
      ![SocksCap64.png](../Images/DS04.png)
...
![DS05{SocksCap64.png}](../Images/DS05.png)
...
![SocksCap64.png](../Images/DS06.png)
...
![SocksCap64.png](../Images/DS07.png)
...
![SocksCap64.png](../Images/DS08.png)
...
![SocksCap64.png](../Images/DS09.png)
...
-  **Prim 算法**
   ...
   ![SocksCap64.png](../Images/DS10.png)
...
-  **Kruskal 算法**
   ...
   ![SocksCap64.png](../Images/DS11.png)
...
-  有权图的单源最短路径
   ...
   ![SocksCap64.png](../Images/DS12.png)
...
![SocksCap64.png](../Images/DS13.png)
...
![SocksCap64.png](../Images/DS14.png)
...
![SocksCap64.png](../Images/DS15.png)
...
-  B 树的插入
   ...
   ![SocksCap64.png](../Images/DS16.png)
...
-  B 树的删除
   ...
   -  若所删除的关键字不在终端结点
      ...
      -  如果都不满足，删掉该关键字，直接将两个子树合并
         ![SocksCap64.png](../Images/DS17.png)

   -  若所删除的关键字在终端结点
      -  如果直接删去仍满足，则直接删除
      -  如果兄弟有富余，则将其“调整”过来即可
         ![SocksCap64.png](../Images/DS18.png)
      -  如果兄弟没有富余，则需要删除之后将父结点中关键字放到兄弟那里
         ![SocksCap64.png](../Images/DS19.png)

#### 8.3.2 B+ 树的基本概念

![SocksCap64.png](../Images/DS20.png)
...
![SocksCap64.png](../Images/DS21.png)
...
![SocksCap64.png](../Images/DS22.png)
